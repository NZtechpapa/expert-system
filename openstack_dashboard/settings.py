...
#SITE_BRANDING = 'Expert Review System'
SITE_BRANDING = u"专家评审系统"
...
#MEDIA_ROOT = None
MEDIA_ROOT = '/var/www/expertreview/media'
MEDIA_URL = None
#STATIC_ROOT = None
STATIC_ROOT = '/var/www/expertreview/static'
STATIC_URL = None
...
POLICY_FILES = {
    ...
    'expertreview': 'expertreview_policy.json',
}
POLICY_DIRS = {}
