...
from horizon.templatetags.horizon import policy_check
...
class DataTableOptions(object):
    ...
    .. attribute:: policy_rules
        ...
        A list of policy_rule names which this table requires in order to be
        displayed. Defaults to an empty list (``[]``).

    .. attribute:: permissions

        A list of permission names which this table requires in order to be
        displayed. Defaults to an empty list (``[]``). It will only take effect
        when policy_rules is not set
    """
    def __init__(self, options):
        ...
        self.policy_rules = getattr(options, 'policy_rules', [])
...
class DataTable(object):
    ...
    def __init__(self, request, data=None, needs_form_wrapper=None, **kwargs):
        ...
        self.policy_rules = self._meta.policy_rules
